  ...
  <section ref="sectionEl" class="py-24 bg-brand-950">
    <div class="max-w-7xl mx-auto px-6">
      ...
      <div class="text-center mb-16" :class="visible ? 'animate-fade-up' : 'opacity-0'">
        <p class="text-gold-400 text-xs font-semibold tracking-[0.4em] uppercase mb-3">Core Values</p>
      ...
      <div class="grid grid-cols-3 gap-8">
        ...
        >
          ...
          <!-- 标题 -->
          <h3 class="text-white font-bold text-lg mb-3">{{ val.title }}</h3>

          <!-- 描述 -->
          <p class="text-neutral-400 text-sm leading-relaxed">{{ val.desc }}</p>

          <!-- 底部标签 -->
          <div class="mt-6 pt-5 border-t border-white/[0.06] flex flex-wrap gap-2">
